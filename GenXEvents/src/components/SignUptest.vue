<template>
          ...
          <div class="c-form__group">
            ...
            <div class="c-form__checkboxes">
                <label class="c-form__checkbox">
                    <input type="checkbox" v-model="selectedHobbies" value="Hiking">
                    Hiking
                </label>
                <label class="c-form__checkbox">
                    <input type="checkbox" v-model="selectedHobbies" value="Cooking">
                    Cooking
                </label>
                <label class="c-form__checkbox">
                    <input type="checkbox" v-model="selectedHobbies" value="Reading">
                    Reading
                </label>
                <label class="c-form__next" for="finish" role="button" @click="signUp">
                    <span class="c-form__nextIcon"></span>
                </label>
                <span class="c-form__groupLabel">What are your hobbies?</span>
            </div>
        </div>
  ...
  .c-checkbox:nth-of-type(1):checked ~ .c-form__progress {
    width: calc(100vw / 4);
  }
  ...
  #finish:checked ~ .c-formContainer .c-form .c-form__group:nth-child(4) {
    transition: 0s;
    visibility: hidden;
    opacity: 0;
  }
  #finish:checked ~ .c-formContainer .c-form .c-form__group:nth-child(4) .c-form__border {
    width: 0;
  }
